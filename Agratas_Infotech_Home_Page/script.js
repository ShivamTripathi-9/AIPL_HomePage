...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (hamburger && option && navbar) {
      hamburger.addEventListener("click", () => {
        ...
        if (hamburger.classList.contains("active")) {
          ...
          isNavGrey = true;
          console.log(
            "Navbar and menu color changed to grey when menu opened"
          );
        } else {
        ...
        item.addEventListener("click", function (event) {
          ...
          document.querySelectorAll(".submenu").forEach((submenu) => {
            if (submenu !== thisSubmenu) {
              ...
              const arrow =
                submenu.previousElementSibling.querySelector(".arrow");
          ...
          const arrow =
            thisSubmenu.previousElementSibling.querySelector(".arrow");
    ...
    document.querySelectorAll(".submenu > li").forEach(function (item) {
      ...
      item.addEventListener("click", function (event) {
        ...
        document
          .querySelectorAll(".inner-submenu")
  ...
  // Close submenus
  document.querySelectorAll(".submenu, .inner-submenu").forEach(function (menu) {
  menu.classList.remove("show"); // Remove the 'show' class
  menu.style.display = ""; // Reset display to its default state
  ...
  // Ensure global states are reset 
  if (typeof option !== "undefined") option.classList.remove("active");
  if (typeof navbar !== "undefined") navbar.classList.remove("scrolled");
  if (typeof hamburger !== "undefined") hamburger.classList.remove("active");
  
  // Reset nav-specific state
  if (typeof isNavGrey !== "undefined") isNavGrey = false;
  
  console.log("All menus and submenu settings have been reset.");
  }
  
    // Additional listeners for address bar interactions
    const addressBarContainer = document.getElementById(
